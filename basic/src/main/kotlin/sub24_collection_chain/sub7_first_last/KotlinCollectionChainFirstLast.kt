package sub24_collection_chain.sub7_first_last
...
fun main() {
    ...
    val result1 = fruits.first { fruit -> fruit.name == "banana" }
    ...
    //      람다 조건에 맞는 첫번째 원소
    //      없으면 null
    val result2 = fruits.firstOrNull { fruit -> fruit.name == "xxx" }
    ...
    //      람다 조건에 맞는 마지막 원소
    //      없으면 NoSuchElementException 발생
    val result3 = fruits.last { fruit -> fruit.name == "banana" }
    ...
    //      람다 조건에 맞는 마지막 원소
    //      없으면 null
    val result4 = fruits.lastOrNull { fruit -> fruit.name == "xxx" }
