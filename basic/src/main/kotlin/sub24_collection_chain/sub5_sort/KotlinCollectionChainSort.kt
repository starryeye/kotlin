package sub24_collection_chain.sub5_sort
...
fun main() {
    ...
    // sortedBy
    //      기본은 오름차순, 람다 결과로 정렬
    val result1 = fruits.sortedBy { fruit -> fruit.currentPrice }

    println(result1)


    //      내림차순
    val result2 = fruits.sortedByDescending { fruit -> fruit.currentPrice }
